...
namespace XPOverflow
{
	...
	/// </summary>
	public class XPOverflowMain : ModMain
	{
		/// Config is accessible at any time, if any is declared.
		public new XPOverflowConfig Config => (XPOverflowConfig)base.Config;
		...
		public override void OnModEnabled() {
			...
			Logger.LogInfo($"XP Overflow Enabled.");
		...
		public override void OnModDisabled() {
			...
			Logger.LogInfo($"XP Overflow disabled.");
		}
